...
.priority-item { display: flex; gap: 14px; align-items: flex-start; padding: 17px 18px; border: 1px solid var(--line); border-radius: var(--card-radius); color: var(--ink); background: var(--white); flex: 1 }
...
@media(max-width:560px) {
  html { scroll-padding-top: 136px }.shell { width: calc(100% - 32px) }
  ...
  .evidence-table thead,.sources-table thead { position: absolute; width: 1px; height: 1px; overflow: hidden; clip-path: inset(50%) }.evidence-table,.evidence-table tbody,.sources-table,.sources-table tbody { display: block }.evidence-table tr,.sources-table tr { display: block; padding: 12px 0; border-bottom: 1px solid var(--line) }.evidence-table td,.sources-table td,.sources-table tbody th { display: block; border: 0; padding: 5px 8px }.evidence-table td:before { display: block; margin-bottom: 4px; color: var(--faint); font: 11px Onest,system-ui,sans-serif }.evidence-table td:nth-child(1):before { content: "Source" }.evidence-table td:nth-child(2):before { content: "Setting / evidence" }.evidence-table td:nth-child(3):before { content: "Observed value" }
...
@media print {
  ...
  table { font-size: 9px }thead th { font-size: 9px; padding: 8px }td,tbody th { padding: 8px }.evidence-table code,.evidence-table pre { font-size: 9px }.evidence-table,.sources-table { display: table }.evidence-table tbody,.sources-table tbody { display: table-row-group }.evidence-table thead,.sources-table thead { position: static; width: auto; height: auto; clip-path: none; display: table-header-group }.evidence-table tr,.sources-table tr { display: table-row }.evidence-table td,.sources-table td,.sources-table tbody th { display: table-cell }.evidence-table td:before { display: none }

...
.regulation-identity { display: flex; align-items: center; gap: 14px; min-width: 0 }.regulation-mark { display: grid; place-items: center; width: 48px; height: 48px; flex: none; border-radius: 13px; background: #eef2f6; color: #3b4a5a }.regulation-identity h2 { font-size: 26px; line-height: 1.15 }.regulation-identity p { margin-top: 5px; color: var(--muted); font-size: 13px }
...
.regulation-tile[data-review-state="missing-evidence"],.regulation-tile[data-review-state="review-required"] { border-color: #e4cfad }
...
.inventory-count[data-total="0"] { display: none }
.inventory-client-tag { display: inline-flex; padding: 3px 7px; border: 1px solid var(--line); border-radius: 6px; font-size: 12px; color: var(--muted) }
.inventory-client-tag .brand-icon { width: 16px; height: 16px }.inventory-client-tags { align-content: start }
.inventory-declarations { grid-column: 1/-1; min-width: 0; font-size: 12px }
.inventory-declarations>summary { display: flex; align-items: center; gap: 8px; width: fit-content; padding: 5px 0; color: var(--brand); list-style: none }
.inventory-declarations>ul { list-style: none; padding: 0 12px; margin: 4px 0; border-left: 2px solid var(--line) }
.declaration-row { display: grid; gap: 6px; padding: 12px 0; border-bottom: 1px solid var(--line) }.declaration-row:last-child { border-bottom: 0 }
...
.inventory-client-location { padding: 0 22px 18px; overflow-wrap: anywhere }
...
@media(max-width:560px) {
  ...
  .evidence-row,.inventory-row { grid-template-columns: 1fr }.inventory-rows { padding: 4px 14px 10px }
  .inventory-group>summary { flex-wrap: wrap }
  .inventory-client-facts { flex-basis: 100%; max-width: none; order: 1; justify-content: flex-start }
...
/* Compact, data-led overview; detail is available through native disclosures. */
.report-title { padding-top: 34px; padding-bottom: 24px }.report-title h1 { font-size: clamp(28px,3.2vw,40px) }.report-subtitle { margin-top: 10px }
.brand img { width: 152px; height: 38px; object-fit: contain }
.visual-overview .overview-intro { display: flex; align-items: center; justify-content: space-between; gap: 20px; padding: 24px 26px 0 }
.visual-overview .overview-intro h2 { font-size: clamp(22px,2.4vw,29px); letter-spacing: -.035em }
.overview-status { display: flex; flex-direction: column; align-items: flex-end; gap: 7px; font-size: 12px; white-space: nowrap }
.coverage-status { display: inline-flex; align-items: center; gap: 6px; border: 1px solid var(--line); border-radius: 7px; padding: 6px 9px; color: var(--muted) }.coverage-status .icon { width: 14px; height: 14px }.overview-info { color: var(--faint) }
.visual-overview .overview-grid { grid-template-columns: minmax(0,.9fr) minmax(0,1.25fr); gap: 22px; padding: 22px 26px }
.visual-overview .priority-chart { display: block; background: #f8fafc; padding: 18px 20px; min-width: 0 }
.visual-overview .chart-row { display: grid; grid-template-columns: 54px minmax(0,1fr) 28px; margin: 10px 0; padding: 2px 0; min-height: 28px; gap: 12px; grid-column: auto }
.visual-overview .bar-chart { height: 16px; border-radius: 5px }.visual-overview .chart-row:hover { text-decoration: none; opacity: .78 }
.visual-overview .chart-footnote { font-size: 11px; margin-top: 12px; padding-top: 10px }.visual-overview .chart-heading { margin-bottom: 12px }
.environment-overview { min-width: 0; padding: 18px 20px; border: 1px solid #d6e8ee; border-radius: var(--card-radius); background: linear-gradient(145deg,#f3fafc,#fff) }.environment-overview .chart-heading a { display: inline-flex; align-items: center; gap: 5px; font-size: 11px }.environment-overview .chart-heading .icon { width: 13px; height: 13px }
.environment-root { display: flex; align-items: center; justify-content: center; gap: 10px; width: fit-content; margin: 0 auto; padding: 8px 20px; background: #fff; border: 1px solid #b9d8e4; border-radius: 9px; color: var(--ink); position: relative }.environment-root:after { content: ''; position: absolute; top: 100%; height: 13px; width: 1px; background: #9dbecb }.environment-root strong { font-size: 26px; line-height: 1.2; font-variant-numeric: tabular-nums }.environment-root span { font-size: 12px }.environment-root .icon { color: #348aae }
.environment-branches { display: grid; grid-template-columns: repeat(3,minmax(0,1fr)); gap: 12px; padding-top: 25px; position: relative }.environment-branches:before { content: ''; position: absolute; left: 16.666%; right: 16.666%; top: 12px; border-top: 1px solid #9dbecb }
.environment-node { display: flex; flex-direction: column; align-items: center; position: relative; min-width: 0; padding: 10px 5px; border: 1px solid #dce8ed; border-radius: 8px; background: #fff; color: var(--ink); text-align: center }.environment-node:before { content: ''; position: absolute; bottom: 100%; height: 13px; border-left: 1px solid #9dbecb }.environment-node strong { font-size: 27px; line-height: 1.2; letter-spacing: -.04em; font-variant-numeric: tabular-nums }.environment-node>span:not(.environment-node-icon) { font-size: 11px; font-weight: 600; margin-top: 2px }.environment-node small { color: var(--faint); font-size: 10px; margin-top: 4px }.environment-node-icon { color: #348aae; margin-bottom: 5px }.environment-node-icon .icon { width: 18px; height: 18px }
.reach-title { font-size: 10px; color: var(--faint); margin-top: 12px }.reach-title+.reach-strip { margin-top: 5px }.reach-strip { margin-top: 14px }.reach-strip>svg { width: 100%; height: 7px; display: block; overflow: hidden; border-radius: 4px; background: #e8edf1 }.reach-fill-local { fill: #43a1d0; background: #43a1d0 }.reach-fill-remote { fill: #5173a9; background: #5173a9 }.reach-fill-unknown { fill: #c2ccd5; background: #c2ccd5 }.reach-fill-disabled { fill: #e2e8ee; background: #e2e8ee }
.reach-legend { display: flex; flex-wrap: wrap; gap: 5px 12px; margin-top: 7px; font-size: 10px; color: var(--muted) }.reach-legend>span { display: inline-flex; align-items: center; gap: 4px }.reach-dot { width: 6px; height: 6px; border-radius: 2px }.reach-legend strong { color: var(--ink); font-weight: 600 }
.priority-shortlist { display: grid; grid-template-columns: repeat(3,minmax(0,1fr)); gap: 12px; padding: 22px 26px 0 }.priority-shortlist .priority-item { padding: 12px 14px; gap: 8px }.priority-shortlist .priority-copy strong { font-size: 12px; line-height: 1.5 }.priority-shortlist .priority-meta { margin-bottom: 6px }.priority-shortlist .severity { font-size: 10px }
.report-disclosure { margin-top: 12px; background: #fff; border: 1px solid var(--line); border-radius: 12px; scroll-margin-top: 94px }.report-disclosure>summary { display: flex; align-items: center; gap: 12px; padding: 18px 22px; list-style: none; cursor: pointer; min-height: 66px }.report-disclosure>summary::-webkit-details-marker,.finding-details>summary::-webkit-details-marker { display: none }.report-disclosure>summary h2 { font-size: 16px; letter-spacing: -.02em; flex: 1; line-height: 1.4 }.disclosure-section-icon { display: flex; color: var(--brand) }.disclosure-section-icon .icon { width: 19px; height: 19px }.disclosure-section-count { color: var(--faint); font-size: 12px }.report-disclosure>summary>.disclosure-icon { margin-left: 4px }.report-disclosure[open]>summary { border-bottom: 1px solid var(--line) }
.report-disclosure-body { padding: 22px }.report-disclosure-body>.report-section { margin: 0; padding: 0 }.report-disclosure-body>.report-section>.section-heading { display: none }.disclosure-intro { font-size: 13px; color: var(--muted); margin-bottom: 16px }
.client-map { list-style: none; padding: 0; margin: 0 }.client-map-row { display: grid; grid-template-columns: minmax(130px,1fr) minmax(220px,1.4fr) minmax(210px,1.2fr); gap: 24px; align-items: center; padding: 16px 0; border-bottom: 1px solid var(--line) }.client-map-row:last-child { border-bottom: 0 }.client-map-identity { min-width: 0 }.client-map-identity .client-identity { font-size: 13px; overflow-wrap: anywhere }.client-components { display: grid; grid-template-columns: repeat(3,minmax(0,1fr)); gap: 8px }.client-component { display: flex; flex-direction: column; align-items: center; padding: 7px 4px; background: var(--surface); border: 1px solid var(--line); border-radius: 7px; color: var(--ink) }.client-component strong { font-size: 21px; line-height: 1.3; font-variant-numeric: tabular-nums }.client-component span { font-size: 10px; color: var(--muted) }.client-reach .reach-strip { margin-top: 0 }.client-reach>small { display: block; margin-top: 5px; color: var(--faint); font-size: 10px }
.finding { padding: 0; overflow: hidden }.finding-details>summary { list-style: none; cursor: pointer; position: relative; padding: 18px 50px 18px 20px }.finding-details>summary h3 { margin-top: 8px; margin-bottom: 0; font-size: 16px }.finding-details>summary>.disclosure-icon { position: absolute; right: 20px; top: 28px }.finding-body { padding: 0 20px 20px }.finding-details[open]>summary { padding-bottom: 12px }.finding-body .finding-summary { margin-top: 0 }.report-footer { margin-top: 26px }.footer-privacy { margin-top: 8px }.report-footer .booking-link { font-size: 12px; padding: 8px 12px; margin-top: 10px }
/* Stored Critical and High findings lead with distinct, readable callouts. */
.priority-shortlist .priority-item { border-left-width: 4px; padding: 16px; align-items: center }
.priority-shortlist .priority-copy strong { font-size: 14px }
.priority-shortlist .priority-item-critical { background: #fff0ef; border-color: #edc0bc; border-left-color: #ba3930 }
.priority-shortlist .priority-item-high { background: #fff5e9; border-color: #efd1a8; border-left-color: #c16a15 }
.priority-shortlist .priority-item-critical:hover { background: #ffe5e2; border-color: #ba3930 }
.priority-shortlist .priority-item-high:hover { background: #ffedd7; border-color: #c16a15 }
.priority-shortlist .priority-item-critical>.icon { color: #a4342c }.priority-shortlist .priority-item-high>.icon { color: #9f510a }
.team-teaser { scroll-margin-top: 100px }
@media (max-width: 900px) {
 .client-map-row { grid-template-columns: minmax(100px,.8fr) minmax(190px,1.2fr); gap: 12px 20px }.client-reach { grid-column: 1/-1 }.visual-overview .overview-grid { gap: 14px; padding: 18px }.visual-overview .overview-intro { padding: 22px 18px 0 }.priority-shortlist { padding: 18px 18px 0 }.environment-overview { padding: 16px 12px }.environment-branches { gap: 6px }.visual-overview .priority-chart { padding: 16px 14px }
}
@media (max-width: 640px) {
 .brand img { width: 112px; height: 28px }.visual-overview .overview-grid { grid-template-columns: 1fr }.visual-overview .overview-intro { align-items: flex-start; flex-direction: column; gap: 10px }.overview-status { flex-direction: row; align-items: center; flex-wrap: wrap; white-space: normal }.priority-shortlist { grid-template-columns: 1fr; gap: 7px }.priority-shortlist .priority-item { padding: 10px 12px }.priority-shortlist .priority-copy { display: flex; align-items: baseline; gap: 10px }.priority-shortlist .priority-meta { margin: 0 }.priority-shortlist .priority-copy strong { font-size: 12px }.visual-overview .chart-row { margin: 7px 0 }.environment-overview { padding: 16px }.report-disclosure>summary { padding: 16px 14px; gap: 9px; flex-wrap: wrap }.report-disclosure>summary h2 { font-size: 15px }.disclosure-section-count { font-size: 10px }.report-disclosure-body { padding: 14px }.client-map-row { grid-template-columns: 1fr }.client-components { grid-column: 1/-1 }.client-reach { grid-column: 1/-1 }.finding-details>summary { padding-left: 14px }.finding-body { padding: 0 14px 14px }.finding-details>summary h3 { font-size: 15px }
}
@media print {
 .visual-overview .overview-grid { grid-template-columns: 1fr 1.2fr }.priority-shortlist { grid-template-columns: repeat(3,1fr) }.report-disclosure { break-inside: auto; margin-top: 14px }.report-disclosure>summary { min-height: 0; padding: 12px 14px; break-after: avoid }.report-disclosure-body { padding: 14px }.finding-details>summary { padding: 12px 14px }.finding-body { padding: 0 14px 14px }.finding-details>summary h3 { font-size: 12px }.client-map-row { grid-template-columns: 1fr 1.4fr 1.2fr; break-inside: avoid }.client-reach { grid-column: auto }.report-disclosure-body>.report-section>.section-heading { display: none }.report-footer .booking-link { display: none }
}
"""

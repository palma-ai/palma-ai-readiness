...
Linux any folder another person's account owns), backups, OS temporary folders, client
staging folders and marketplace clones, and the scanner's own folder are not traversed. The report's coverage section says when any were
